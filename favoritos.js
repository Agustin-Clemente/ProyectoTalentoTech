...
function mostrarFavoritos() {
    ...
    if (favoritos.length === 0) {
        ...
        favoritos.forEach(rescatado => {
            ...
            const apadrinar = document.createElement("p");
            apadrinar.className = "apadrinar";
            apadrinar.textContent = "Apadrinar con";
            ...
            donacionContainer.appendChild(apadrinar)
            ...
            if (rescatado.donacion) {
                apadrinar.textContent = "Modificar donación";
